...
//---------------------------------------------------------------------
void silkworm::gravity(){
    for (int i = 0; i < particles.size(); i++){
        particles[i].addForce(0,0.3);
    }
}
//---------------------------------------------------------------------
void silkworm::update(){
    ...
    trail.push_back(particles[7].pos);
    if (trail.size() > 30){
...
//---------------------------------------------------------------------
void silkworm::moveToPoint(int x, int y){
	particles[0].pos.set(x, y);
}


//---------------------------------------------------------------------
void silkworm::fixHead(){
    particles[0].bFixed = true;
}


//---------------------------------------------------------------------
void silkworm::releaseHead(){
